...
Leave the text fields blank and the picture becomes the whole card. That is not a
  ...
  rows={[
    {
      ...
      type: "string",
      description:
        "The pictures, split by `|` — not by comma, because a data: URL has one of its own. The rail repeats them if it runs out",
    },
    { name: "titles", type: "string", description: "One title per card, split by `|`" },
    { name: "notes", type: "string", description: "One line of small print per card" },
    { name: "tags", type: "string", description: "One tag per card" },
    {
      name: "heading",
      type: "string",
