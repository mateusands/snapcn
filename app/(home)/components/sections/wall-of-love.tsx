 ...
 *
 * `aria-hidden` with the fact in the name row's text instead would be cleaner
 * if the name were a heading — it is not, so the badge carries its own label
 * and a screen reader reads "Nett0, verified account".
 */
const VerifiedIcon = () => (
  <svg
    viewBox="0 0 24 24"
